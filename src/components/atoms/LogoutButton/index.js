...
const LogoutButton = ({ className, wrapperClassName, label }) => (
    <label htmlFor="wwnLogout" className={wrapperClassName}>
        <Link to="/" id="wwnLogout" role="button" className={className} title={label}>
            ...
            <i className="logout">
                ...
                <svg version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink" x="0px" y="0px" viewBox="0 0 512 512" style={{enableBackground: 'new 0 0 512 512'}} xmlSpace="preserve">
                    <path style={{fill: '#999999'}} d="M321.628,446.372c-63.339,0-122.346-31.372-157.846-83.917c-7.196-10.651-4.394-25.117,6.256-32.313
                ...
                C512,360.971,426.598,446.372,321.628,446.372z" />
                    <path style={{ fill: '#EC3D4B'}} d="M349.088,232.727H79.458l30.09-30.089c9.089-9.089,9.089-23.824,0-32.912
        ...
        <span className="wwn-logout-text d-none d-md-inline-block">{label}</span>
    </label>
);
